...
![github actions secrets 추가](assets/img/posts/2025-05-21-판-벌리기/10.png)
...
![네트워크 요청 결과](assets/img/posts/2025-05-21-판-벌리기/11.png)

2. Lambda 로그(CW Logs) 확인
AWS 콘솔 → CloudWatch → 로그 그룹 `/aws/lambda/clickstream-ingest` 에서 실제 페이로드가 기록되었는지 확인했습니다.
![lambda logs](assets/img/posts/2025-05-21-판-벌리기/12.png)
